...
//We extract the data from Yolo11-segmentor the model, using the MetaDataExtractor from thensorflow lite
// in our case we got two classes : 0: egg-berried lobster(s) and 1: General lobster(s)
object MetaData {
